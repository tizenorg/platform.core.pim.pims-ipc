...
//static GHashTable *client_info_map; // key : client_id, data : pims_ipc_client_info_s*
...
void client_init(void)
{
	...
	worker_client_info_map = g_hash_table_new_full(g_direct_hash, g_direct_equal, NULL,
			client_destroy_info);
//	client_info_map = g_hash_table_new_full(g_str_hash, g_str_equal, g_free,
//			client_destroy_info);
}
...
//	g_hash_table_destroy(client_info_map);
}
...
//	g_hash_table_insert(client_info_map, g_strdup(client_id), client_info);
